...
# Example:
#
# upload_artefact_to_github.sh github_api_token=TOKEN owner=orange-cloudfoundry repo=osb-reverse-proxy tag=v0.1.0 filename=./cf-ops-automation-terraform-broker-0.5.0-SNAPSHOT.jar
#
