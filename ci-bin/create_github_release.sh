...
# Example:
#
# create_github_release.sh github_api_token=TOKEN owner=orange-cloudfoundry repo=osb-reverse-proxy tag=v0.1.0
#
...
GITHUB_RELEASE="$GITHUB_API/repos/orange-cloudfoundry/osb-reverse-proxy/releases"
