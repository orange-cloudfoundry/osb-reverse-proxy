 ...
 */
public class ExtendedReadBodyPredicateFactory
		extends AbstractRoutePredicateFactory<ExtendedReadBodyPredicateFactory.Config> {
	...
	public ExtendedReadBodyPredicateFactory() {
		super(Config.class);
		this.messageReaders = HandlerStrategies.withDefaults().messageReaders();
	}

	public ExtendedReadBodyPredicateFactory(List<HttpMessageReader<?>> messageReaders) {
		super(Config.class);
					...
					return ServerWebExchangeUtils.cacheRequestBodyAndRequest(exchange,
							(serverHttpRequest) -> ServerRequest
									...
									.map(objectValue -> config.getPredicate()
											.test(objectValue)))
									.thenReturn(true); //See https://github.com/spring-cloud/spring-cloud-gateway/issues/1147#issuecomment-641027456
				}
			}
